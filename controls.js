...
function handleInput(entity) {
    ...
    if (!entity.isAttackingSword && !entity.isAttackingBow && !entity.isRecoiling && !entity.isDead) {
        ...
        switch (key) {
            ...
            case 'j':   // Attack input.
                if(entity.cooldown) entity.cooldown--;
                else if (entity.direction === 'up') setBattleState(entity, "",'Up');
            ...
            case 'w':   // Up input.
                if (entity.game.userInput.includes('s')) {    // Up - Down case.
                    ...
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "",'Up');
                } else if (entity.game.userInput.includes("k")) {
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "Bow", "Up");
                } else {  // Up case.
            ...
            case 's':   // Down input.
                if (entity.game.userInput.includes('w')) {    // Down - Up case.
                    ...
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "",'Down');
                } else if (entity.game.userInput.includes("k")) {
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity,"Bow","Down");
                }
                else {  // Down case.
            ...
            case 'a':   // Left input.
                if (entity.game.userInput.includes('w')) {    // Left - Up case.
                    ...
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "",'Left');
                } else if (entity.game.userInput.includes('k')) {
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "Bow", "Left");
                } else {  // Left case.
            ...
            case 'd':   // Right input.
                if (entity.game.userInput.includes('w')) {    // Right - Up case.
                    ...
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity, "",'Right');
                } else if (entity.game.userInput.includes("k")) {
                    if(entity.cooldown) entity.cooldown--;
                    else setBattleState(entity,"Bow", "Right");
                } else {  // Right case.
